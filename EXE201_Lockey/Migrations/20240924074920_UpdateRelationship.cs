        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(type: "int", nullable: false),
                    TemplateID = table.Column<int>(type: "int", nullable: false),
                    UploadedImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChosenColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomDesigns", x => x.DesignID);
                    table.ForeignKey(
                        name: "FK_CustomDesigns_Templates_TemplateID",
                        column: x => x.TemplateID,
                        principalTable: "Templates",
                        principalColumn: "TemplateID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomDesigns_Users_UserID",
                        column: x => x.UserID,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CustomDesigns_DesignID",
                        column: x => x.DesignID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomDesigns_TemplateID",
                table: "CustomDesigns",
                column: "TemplateID");
